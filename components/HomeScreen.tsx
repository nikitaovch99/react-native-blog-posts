...
import { userPost } from "../types/typePost";
import { PostFromServer } from "../types/typePost";
...
export const HomeScreen = ({ navigation }: Props) => {
  ...
  const userPosts: userPost[] = postsFromServer.filter(
  ...
  return isLoading ? (
    ...
    <View>
      <FlatList
        ...
        data={userPosts}
        renderItem={({ item }) => (
          <TouchableOpacity onPress={() => handlePostPress(true, item.id)}>
